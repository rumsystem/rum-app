export const content = {
  ...
  confirmToDeleteSeedNet: '确定要删除这个种子网络吗？',
  confirmToDeletePost: '确定要删除这篇文章吗？',
  ...
  selectExternalNodeStoragePathTip: '使用外部节点会产生一些临时数据<br/>请选择一个文件夹来存储它们',
  storagePathTip: '请选择一个文件夹来储存节点数据<br/>这份数据只是属于你<br/>我们不会储存数据，也无法帮你找回<br/>请务必妥善保管',
  storagePathTip2: '请选择一个文件夹来储存节点数据，这份数据只是属于你，我们不会储存数据，也无法帮你找回，请务必妥善保管',
  storagePathLoginTip: '创建节点时您选择了一个文件夹<br/>里面保存了您的节点信息<br/>现在请重新选中该文件夹<br/>以登录该节点',
  ...
  singleProducerConfirm: '你是本种子网络唯一的出块节点，你退出之后，种子网络将永久作废，也无法正常使用。<br /><br />如果退出之后，仍然想要种子网络能继续正常运行，你可以添加另外一个出块节点来承担出块的工作<br /><br />',
  singleProducerConfirmAll: '你是一些种子网络唯一的出块节点，你退出之后，种子网络将永久作废，也无法正常使用。<br /><br />如果退出之后，仍然想要种子网络能继续正常运行，你可以添加另外一个出块节点来承担出块的工作<br /><br />',
  addProducerFeedback: '我已经通过了你的申请，欢迎你成为本种子网络的出块节点',
  removeProducerFeedback: '我已经将你从出块节点的名单中移除，你不再是本种子网络的出块节点',
  ...
  selectExportMode: '选择导出类型',
  exportForRumApp: '导出给 rum-app 的格式',
  exportForWasm: '导出给浏览器的格式',
  selectImportMode: '选择导入类型',
  importForRumApp: '导入 rum-app 的备份格式',
  importForWasm: '导入浏览器的备份格式',
  restoreBackupSeeds: '正在恢复种子网络',
  ...
  labTip1: '欢迎提前体验 Rum 中还未正式发布的实验性功能，',
  labTip2: '你可以在下面列表里选择开启或关闭。',
  labTip3: '实验性功能可能不够完善或稳定。',
  traffic: '流量',
  lastHour: '最近一小时',
  lastDay: '最近24小时',
  lastMouth: '最近一个月',
