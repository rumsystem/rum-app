export const content = {
  ...
  document: '档案',
  snsDesc: '以时间线形式呈现该种子网络内发布的内容。所有加入该网络的成员都可以用短文本或图片来即时发布自己的想法或状态，或点赞、回复、打赏其它人的发布。',
  forumDesc: '以主题贴的形式呈现该种子网络里发布的内容。支持6层回复，可对某主题进行深入讨论。可以对主题帖点“赞”或“踩” 以决定它的排序。',
  noteDesc: '只有创建者或得到创建者许可的成员可以发布内容、阅读/解密内容。所有内容都是加密保存到链上。可用于私人笔记、日记、不公开的多人笔记或加密存档个人文档。',
  cancel: '取消',
  save: '保存',
  saved: '已保存',
