export const content = {
  ...
  reset: '重置',
  hasReset: '已重置',
  failToAccessProxyNode: (host: string, port: string) => `外部节点无法访问，请检查一下<br />${host}:${port}`,
  tryAgain: '再次尝试',
  tipped: '打赏成功',
  search: '搜索',
  selectToken: '选择币种',
  ...
  proxyNode: '外部节点',
  proxyMode: '外部节点模式',
  proxyNodeTip: '连接到公开可访问的节点',
  selectProxyNodeStoragePathTip1: '使用外部节点会产生一些临时数据',
  selectProxyNodeStoragePathTip2: '请选择一个文件夹来存储它们',
  ...
  exitBeforeEditingProxyNodeInfo: '修改节点信息之前，会先退出当前节点',
  nodeInfo: '节点信息',
  savePassword: '记住密码',
