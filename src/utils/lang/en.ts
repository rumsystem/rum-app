export const content = {
  ...
  applyToAllForProfile: 'Use this profile in all SeedNets',
  connected: 'Connected',
  ...
  message: 'Message',
  afterUnFollowTip: 'Set up successfully, click the menu in the upper right corner to view member muted',
  confirmToUnFollow: 'Are you sure you want to mute this member? ',
  ban: 'Ban this member from posting',
  unBan: 'Unban this member from posting',
  ...
  maxByteLength: (byteLength: string) => `Image total size no more than ${byteLength}`,
};
