export const content = {
  ...
  rumLab: 'Rum Lab',
  paidFunc: 'Paid Function',
  debugQuorum: 'Export Quorum Debug Log',
  requireRelaunch: 'relaunch is required',
  testConnect: 'test connection status',
  exportQuorumLog: 'export quorum logs to debug package for analysis',
  useTestNet: 'link to rum test net for using new function in developing',
  searchPublicNode: 'improve connection by agressive looking public node ',
  chargeBlitity: 'can create charged seedNet',
  youCanJoinGroup: 'you can joing seedNet',
  helpUsImprove: 'help us improve by provide feedback.',
