          ...
          try {
            ...
            for (const user of announcedUsers) {
              try {
                ...
                const isPaidUser = await contract.isPaid(QuorumLightNodeSDK.utils.pubkeyToAddress(user.AnnouncedSignPubkey), ethers.BigNumber.from('0x' + group.group_id.replace(/-/g, '')));
